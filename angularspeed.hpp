...
public:
    ...
    inline constexpr angularspeed  operator+() const {return *this;}
    inline constexpr angularspeed  operator-() const {return angularspeed(-__rep_);}
    ...
    inline static constexpr angularspeed zero() {return angularspeed(angularspeed_values<rep>::zero());}
    inline static constexpr angularspeed min()  {return angularspeed(angularspeed_values<rep>::min());}
    inline static constexpr angularspeed max()  {return angularspeed(angularspeed_values<rep>::max());}
};
