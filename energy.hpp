...
struct common_type< metric::energy<_Rep1, _Period1>,
                    metric::energy<_Rep2, _Period2> >
{   
	    typedef metric::energy<typename common_type<_Rep1, _Rep2>::type,
...
public:
    ...
    inline constexpr energy  operator+() const {return *this;}
    inline constexpr energy  operator-() const {return energy(-__rep_);}
    ...
    inline static constexpr energy zero() {return energy(energy_values<rep>::zero());}
    inline static constexpr energy min()  {return energy(energy_values<rep>::min());}
    inline static constexpr energy max()  {return energy(energy_values<rep>::max());}
};
