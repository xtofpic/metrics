...
struct common_type< metric::electricresistance<_Rep1, _Period1>,
                    metric::electricresistance<_Rep2, _Period2> >
{
            typedef metric::electricresistance<typename common_type<_Rep1, _Rep2>::type,
